    ...
    <div class="container main-container">
        <div class="row">
            <div class="col-md-12 hero-feature">
                <span class="title">spacewalksales.com Privacy Policy</span>
                ...
                <p>We collect information from you when you place an order, fill out a form or enter information on our
                    site.</p>
                ...
                <p>We may use the information we collect from you when you register, make a purchase, sign up for our
                    ...
                    site features in the following ways:</p>
                ...
                <p>Your personal information is contained behind secured networks and is only
                    ...
                    you supply is encrypted via Secure Socket Layer (SSL) technology.</p>
                ...
                <p>All transactions are processed through a gateway provider and are not stored
                    or processed on our servers.</p>
                ...
                <p>You can choose to have your computer warn you each time a cookie is being
                ...
                <p>If you turn cookies off, some features will be disabled. Some of the features
                    that make your site experience more efficient and may not function properly, however, you will still
                    be
                    able to place orders items in cart.</p>
                ...
                <p>Users can set preferences for how Google advertises to you using the Google Ad Settings
                    ...
                    Out page or by using the Google Analytics Opt Out Browser add on.</p>

                <h4>California Online Privacy Protection Act</h4>
                <p>CalOPPA is the first state law in the nation to require commercial websites
                ...
                <p><b>According to CalOPPA, we agree to the following:</b>
                <p>Users can visit our site anonymously.</p>
                <p>Once this privacy policy is created, we will add a link to it on our home
                    page or as a minimum, on the first significant page after entering our website.</p>
                <p>Our Privacy Policy link includes the word 'Privacy' and can be easily be
                    found on the page specified above.</p>

                <b>You will be notified of any Privacy Policy changes:</b>
                <ul>
                    <li> On our Privacy Policy Page
                </ul>
                <b>Can change your personal information:</b>
                <ul>
                ...
                <p>In order to be in line with Fair Information Practices we will take
                    the following responsive action, should a data breach occur:</p>
                ...
                <p>We also agree to the Individual Redress Principle which requires that
                    ...
                    government agencies to investigate and/or prosecute non-compliance by data processors.</p>

                <h4>CAN SPAM Act</h4>
                <p>The CAN-SPAM Act is a law that sets the rules for commercial email,
                ...
                <p><b>We collect your email address in order to:</b>
                <ul>
                ...
                <p><b>To be in accordance with CANSPAM, we agree to the following:</b>
                <ul>
                ...
                <p><b>If at any time you would like to unsubscribe from receiving future emails, you can email us at</b>
                <ul>
                    <li>Follow the instructions at the bottom of each email and we will promptly remove you from
                ...
                <p>If there are any questions regarding this privacy policy, you may contact us using the information
                    below.</p>
                <p>SpaceWalkSales.com<br/>
                    450 31st St.<br/>
                    Kenner, LA 70065<br/>
                    United States<br/>
                    info@herecomesfun.com<br/>
                    800-622-6026</p>
                <p>Last Edited on 2016-09-02</p>
            </div>
        </div>
    </div>
