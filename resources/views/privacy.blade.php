        ...
        <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 visible-lg visible-md">
                    ...
                    <div class="thumbnail col-lg-12 col-md-12 col-sm-6 visible-lg visible-md text-center">
                        ...
                        <div class="caption prod-caption">
                            ...
                            <p>
                            <div class="btn-group">
                                <a href="typography.html#" class="btn btn-default">$ 928.96</a>
                                <a href="typography.html#" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Buy</a>
                            </div>
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12 hero-feature">
                    ...
                    <hr />
                    <p><a href="typography.html#">Link</a></p>
